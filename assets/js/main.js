...
(function ($) {
    ...
    <div class="links">
				...
				<section class="split">
					<section>
						<div class="contact-method">
							...
							<h3>Email</h3>
							<a href="mailto:Hussein.Ubeid@outlook.com">Hussein.Ubeid@outlook.com</a>
						</div>
					</section>
					<section>
						<div class="contact-method">
							...
							<h3>Location</h3>
							<span>Somewhere in Finland :D</span>
						</div>
					</section>
				</section>
			</div>
		...
		<div class="inner">
			<ul class="icons">
				<li><a href="https://twitter.com/ultikynnys" class="icon brands fa-twitter"><span class="label"></span></a></li>
				...
				<li><a href="CV.html" class="icon solid fa-envelope-open-text"><span class="label">LinkedIn</span></a></li>
			</ul>
			<ul class="copyright">
